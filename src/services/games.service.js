...
function normalizeGame(row, roadmapRows, trophyRows) {
  ...
  const useSeedTrophyRows = ['a-way-out', 'armored-core-vi-fires-of-rubicon', 'assassins-creed-mirage', 'assassins-creed-origins', 'assassins-creed-odyssey', 'assassins-creed-shadows', 'assassins-creed-valhalla', 'it-takes-two', 'lego-batman-legacy-of-the-dark-knight', 'stray', 'the-witcher-3-wild-hunt'].includes(normalizedSlug) && Array.isArray(seedGame?.trophies) && seedGame.trophies.length > 0;
