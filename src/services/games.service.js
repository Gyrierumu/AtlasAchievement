...
const CATALOG_IMAGE_BY_SLUG = {
  ...
  'rise-of-the-ronin': '/assets/games/rise-of-the-ronin/cover.png',
...
function normalizeGame(row, roadmapRows, trophyRows) {
  ...
  const useAssassinsCreedMirageSeedEditorial = normalizedSlug === 'assassin-s-creed-mirage' && seedGame;
  const useAssassinsCreedOriginsSeedEditorial = normalizedSlug === 'assassin-s-creed-origins' && seedGame;
  const useAssassinsCreedOdysseySeedEditorial = normalizedSlug === 'assassin-s-creed-odyssey' && seedGame;
  const useAssassinsCreedShadowsSeedEditorial = normalizedSlug === 'assassin-s-creed-shadows' && seedGame;
  const useAssassinsCreedValhallaSeedEditorial = normalizedSlug === 'assassin-s-creed-valhalla' && seedGame;
  ...
  const useSeedTrophyRows = (usePrinceOfPersiaLostCrownSeedEditorial || useRatchetRiftApartSeedEditorial || useReturnalSeedEditorial || useRoad96SeedEditorial || useSplitFictionSeedEditorial || useStarWarsJediFallenOrderSeedEditorial || useStarWarsJediSurvivorSeedEditorial || useBlackMythWukongSeedEditorial || normalizedSlug === '007-first-light' || normalizedSlug === 'assassins-creed-iv-black-flag' || normalizedSlug === 'inside' || ['blasphemous', 'grand-theft-auto-v', 'rise-of-the-ronin'].includes(normalizedSlug) || normalizedSlug === 'mixtape' || VERIFIED_PERSONA_GUIDE_SLUGS.has(normalizedSlug) || ['a-way-out', 'armored-core-vi-fires-of-rubicon', 'assassin-s-creed-mirage', 'assassin-s-creed-origins', 'assassin-s-creed-odyssey', 'assassin-s-creed-shadows', 'assassin-s-creed-valhalla', 'avatar-frontiers-of-pandora', 'baldurs-gate-3', 'beyond-two-souls', 'cyberpunk-2077', 'dark-souls-ii-scholar-of-the-first-sin', 'demons-souls', 'disney-epic-mickey-rebrushed', 'dragons-dogma-2', 'final-fantasy-vii-remake', 'final-fantasy-vii-rebirth', 'final-fantasy-xvi', 'gran-turismo-7', 'heavy-rain', 'it-takes-two', 'lego-batman-legacy-of-the-dark-knight', 'life-is-strange-true-colors', 'little-nightmares-ii', 'reanimal', 'silent-hill-2-remake', 'stray', 'the-evil-within', 'the-witcher-3-wild-hunt'].includes(normalizedSlug)) && Array.isArray(seedGame?.trophies) && seedGame.trophies.length > 0;
  ...
  const useSeedRoadmap = (usePrinceOfPersiaLostCrownSeedEditorial || useRatchetRiftApartSeedEditorial || useReturnalSeedEditorial || useRoad96SeedEditorial || useSplitFictionSeedEditorial || useStarWarsJediFallenOrderSeedEditorial || useStarWarsJediSurvivorSeedEditorial || useBlackMythWukongSeedEditorial || normalizedSlug === '007-first-light' || normalizedSlug === 'assassins-creed-iv-black-flag' || normalizedSlug === 'inside' || ['blasphemous', 'grand-theft-auto-v', 'rise-of-the-ronin'].includes(normalizedSlug) || normalizedSlug === 'mixtape' || VERIFIED_PERSONA_GUIDE_SLUGS.has(normalizedSlug) || ['a-way-out', 'armored-core-vi-fires-of-rubicon', 'assassin-s-creed-mirage', 'assassin-s-creed-origins', 'assassin-s-creed-odyssey', 'assassin-s-creed-shadows', 'assassin-s-creed-valhalla', 'avatar-frontiers-of-pandora', 'baldurs-gate-3', 'beyond-two-souls', 'bloodborne', 'clair-obscur-expedition-33', 'cyberpunk-2077', 'dark-souls-ii-scholar-of-the-first-sin', 'dark-souls-iii', 'dark-souls-remastered', 'days-gone', 'dead-cells', 'death-stranding', 'death-stranding-2-on-the-beach', 'demons-souls', 'detroit-become-human', 'disney-epic-mickey-rebrushed', 'dragons-dogma-2', 'final-fantasy-vii-remake', 'final-fantasy-vii-rebirth', 'final-fantasy-xvi', 'god-of-war', 'god-of-war-ragnarok', 'gran-turismo-7', 'hades', 'heavy-rain', 'hogwarts-legacy', 'hollow-knight-silksong', 'horizon-forbidden-west', 'horizon-zero-dawn', 'it-takes-two', 'lego-batman-legacy-of-the-dark-knight', 'lies-of-p', 'life-is-strange-double-exposure', 'life-is-strange-remastered', 'life-is-strange-true-colors', 'little-nightmares-ii', 'lords-of-the-fallen', 'marvels-spider-man', 'marvels-spider-man-2', 'marvels-spider-man-miles-morales', 'reanimal', 'red-dead-redemption-2', 'resident-evil', 'resident-evil-2-remake', 'resident-evil-3-remake', 'resident-evil-5', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'resident-evil-requiem', 'sekiro-shadows-die-twice', 'stray', 'the-evil-within', 'the-witcher-3-wild-hunt', 'until-dawn'].includes(normalizedSlug)) && Array.isArray(seedGame?.roadmap);
  const explicitOfflineBaseSlugs = ['blasphemous', 'rise-of-the-ronin', 'armored-core-vi-fires-of-rubicon', 'assassin-s-creed-mirage', 'avatar-frontiers-of-pandora', 'baldurs-gate-3', 'black-myth-wukong', 'bloodborne', 'clair-obscur-expedition-33', 'cyberpunk-2077', 'dark-souls-ii-scholar-of-the-first-sin', 'dark-souls-iii', 'dark-souls-remastered', 'days-gone', 'detroit-become-human', 'disney-epic-mickey-rebrushed', 'dragons-dogma-2', 'elden-ring', 'astro-bot', 'astros-playroom', 'dead-cells', 'final-fantasy-vii-remake', 'final-fantasy-vii-rebirth', 'final-fantasy-xvi', 'god-of-war', 'god-of-war-ragnarok', 'hades', 'heavy-rain', 'hogwarts-legacy', 'hollow-knight', 'hollow-knight-silksong', 'horizon-forbidden-west', 'horizon-zero-dawn', 'life-is-strange-double-exposure', 'life-is-strange-remastered', 'lego-batman-legacy-of-the-dark-knight', 'marvels-spider-man', 'marvels-spider-man-2', 'marvels-spider-man-miles-morales', 'nioh-2', 'nioh-3', 'resident-evil', 'resident-evil-2-remake', 'resident-evil-3-remake', 'resident-evil-5', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'resident-evil-requiem', 'road-96', 'saros', 'sekiro-shadows-die-twice', 'silent-hill-2-remake', 'star-wars-jedi-fallen-order', 'star-wars-jedi-survivor', 'the-evil-within', 'the-last-of-us-part-i', 'the-last-of-us-part-ii', 'subnautica', 'until-dawn'];
  ...
  return {
    ...
    chapterRouteGuide: seedGame?.chapterRouteGuide && typeof seedGame.chapterRouteGuide === 'object'
      ...
      : null,
    professionalAiGuide: seedGame?.professionalAiGuide && typeof seedGame.professionalAiGuide === 'object'
      ? JSON.parse(JSON.stringify(seedGame.professionalAiGuide))
      : null,
    ...
    attentionPoints: Array.isArray(seedGame?.attentionPoints) ? seedGame.attentionPoints.map(item => ({ ...item })) : (Array.isArray(editorialSource.attentionPoints) ? editorialSource.attentionPoints.map(item => ({ ...item })) : []),
    faq: seedFaq.length
      ? seedFaq
    ...
    chapterSelect: ['007-first-light', 'assassins-creed-iv-black-flag', 'grand-theft-auto-v', 'inside', 'mixtape', 'rise-of-the-ronin'].includes(normalizedSlug) ? true : (['a-way-out', 'detroit-become-human', 'final-fantasy-vii-remake', 'final-fantasy-vii-rebirth', 'heavy-rain', 'life-is-strange-double-exposure', 'life-is-strange-remastered', 'life-is-strange-true-colors', 'little-nightmares-ii', 'reanimal', 'resident-evil-5', 'resident-evil-6', 'split-fiction', 'the-evil-within', 'the-last-of-us-part-i', 'the-last-of-us-part-ii', 'until-dawn'].includes(normalizedSlug) ? true : (['blasphemous', 'nioh-3', 'road-96', 'saros', 'star-wars-jedi-fallen-order', 'star-wars-jedi-survivor', 'subnautica'].includes(normalizedSlug) ? false : undefined)),
    missionReplay: ['grand-theft-auto-v', 'nioh-3', 'rise-of-the-ronin'].includes(normalizedSlug) ? true : (normalizedSlug === 'blasphemous' ? false : undefined),
    openWorldCleanup: ['blasphemous', 'grand-theft-auto-v', 'rise-of-the-ronin', 'subnautica'].includes(normalizedSlug) ? true : undefined,
    onlineRequired: explicitOfflineBaseSlugs.includes(normalizedSlug) ? false : (seedGame?.onlineRequired ?? seedGame?.online_required ?? editorialSource.onlineRequired ?? editorialSource.online_required),
    coopRequired: explicitOfflineBaseSlugs.includes(normalizedSlug) ? false : (seedGame?.coopRequired ?? seedGame?.coop_required ?? editorialSource.coopRequired ?? editorialSource.coop_required),
    ...
    dlcRequired: explicitOfflineBaseSlugs.includes(normalizedSlug) ? false : (seedGame?.dlcRequired ?? seedGame?.dlc_required ?? editorialSource.dlcRequired ?? editorialSource.dlc_required),
    hasMissables: seedGame?.hasMissables ?? seedGame?.has_missables ?? editorialSource.hasMissables ?? Boolean(resolvedMissableCount),
    ...
    newGamePlusRequired: ['armored-core-vi-fires-of-rubicon', 'black-myth-wukong', 'final-fantasy-xvi', 'marvels-spider-man-miles-morales', 'silent-hill-2-remake', 'the-evil-within', 'the-last-of-us-part-ii'].includes(normalizedSlug) ? true : (['007-first-light', 'assassin-s-creed-mirage', 'assassins-creed-iv-black-flag', 'blasphemous', 'clair-obscur-expedition-33', 'days-gone', 'dead-cells', 'detroit-become-human', 'final-fantasy-vii-remake', 'final-fantasy-vii-rebirth', 'god-of-war-ragnarok', 'grand-theft-auto-v', 'hogwarts-legacy', 'horizon-forbidden-west', 'horizon-zero-dawn', 'inside', 'lego-batman-legacy-of-the-dark-knight', 'marvels-spider-man', 'marvels-spider-man-2', 'mixtape', 'resident-evil', 'resident-evil-2-remake', 'resident-evil-3-remake', 'resident-evil-5', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'rise-of-the-ronin', 'road-96', 'split-fiction', 'star-wars-jedi-fallen-order', 'star-wars-jedi-survivor', 'the-last-of-us-part-i'].includes(normalizedSlug) ? false : undefined),
    difficultyTrophiesRequired: ['baldurs-gate-3', 'dead-cells', 'final-fantasy-vii-remake', 'final-fantasy-vii-rebirth', 'final-fantasy-xvi', 'resident-evil', 'resident-evil-2-remake', 'resident-evil-3-remake', 'resident-evil-5', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'rise-of-the-ronin', 'the-evil-within', 'the-witcher-3-wild-hunt'].includes(normalizedSlug) ? true : (['007-first-light', 'armored-core-vi-fires-of-rubicon', 'assassin-s-creed-mirage', 'assassins-creed-iv-black-flag', 'black-myth-wukong', 'blasphemous', 'clair-obscur-expedition-33', 'dark-souls-ii-scholar-of-the-first-sin', 'days-gone', 'detroit-become-human', 'disney-epic-mickey-rebrushed', 'dragons-dogma-2', 'god-of-war-ragnarok', 'gran-turismo-7', 'grand-theft-auto-v', 'heavy-rain', 'hogwarts-legacy', 'horizon-forbidden-west', 'horizon-zero-dawn', 'inside', 'lego-batman-legacy-of-the-dark-knight', 'life-is-strange-true-colors', 'marvels-spider-man', 'marvels-spider-man-2', 'marvels-spider-man-miles-morales', 'mixtape', 'returnal', 'road-96', 'silent-hill-2-remake', 'split-fiction', 'star-wars-jedi-fallen-order', 'star-wars-jedi-survivor', 'the-last-of-us-part-i', 'the-last-of-us-part-ii'].includes(normalizedSlug) ? false : undefined),
    ...
    trophies: normalizedTrophyRows.map(item => {
      ...
      const useSeedEditorialTrophy = (usePrinceOfPersiaLostCrownSeedEditorial || useRatchetRiftApartSeedEditorial || useReturnalSeedEditorial || useRoad96SeedEditorial || useSplitFictionSeedEditorial || useStarWarsJediFallenOrderSeedEditorial || useStarWarsJediSurvivorSeedEditorial || useBlackMythWukongSeedEditorial || normalizedSlug === '007-first-light' || normalizedSlug === 'assassins-creed-iv-black-flag' || normalizedSlug === 'inside' || ['blasphemous', 'grand-theft-auto-v', 'rise-of-the-ronin'].includes(normalizedSlug) || normalizedSlug === 'mixtape' || VERIFIED_PERSONA_GUIDE_SLUGS.has(normalizedSlug) || ['a-way-out', 'armored-core-vi-fires-of-rubicon', 'assassin-s-creed-mirage', 'assassin-s-creed-origins', 'assassin-s-creed-odyssey', 'assassin-s-creed-shadows', 'assassin-s-creed-valhalla', 'avatar-frontiers-of-pandora', 'baldurs-gate-3', 'beyond-two-souls', 'bloodborne', 'celeste', 'clair-obscur-expedition-33', 'cyberpunk-2077', 'dark-souls-ii-scholar-of-the-first-sin', 'dark-souls-iii', 'dark-souls-remastered', 'days-gone', 'dead-cells', 'death-stranding', 'death-stranding-2-on-the-beach', 'demons-souls', 'detroit-become-human', 'disney-epic-mickey-rebrushed', 'dragons-dogma-2', 'final-fantasy-vii-remake', 'final-fantasy-vii-rebirth', 'final-fantasy-xvi', 'god-of-war', 'god-of-war-ragnarok', 'gran-turismo-7', 'hades', 'heavy-rain', 'hogwarts-legacy', 'hollow-knight-silksong', 'horizon-forbidden-west', 'horizon-zero-dawn', 'it-takes-two', 'lego-batman-legacy-of-the-dark-knight', 'lies-of-p', 'life-is-strange-double-exposure', 'life-is-strange-remastered', 'life-is-strange-true-colors', 'little-nightmares-ii', 'lords-of-the-fallen', 'marvels-spider-man', 'marvels-spider-man-2', 'marvels-spider-man-miles-morales', 'reanimal', 'red-dead-redemption-2', 'resident-evil', 'resident-evil-2-remake', 'resident-evil-3-remake', 'resident-evil-5', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'resident-evil-requiem', 'silent-hill-2-remake', 'stray', 'the-evil-within', 'the-witcher-3-wild-hunt', 'until-dawn'].includes(normalizedSlug)) && seedTrophy;
      ...
      return {
        ...
        namePtSource: namePt && LOCALIZED_TROPHY_SOURCE_SLUGS.has(normalizedSlug) ? (seedTrophy?.namePtSource || (['a-way-out', 'assassin-s-creed-origins', 'assassin-s-creed-odyssey', 'avatar-frontiers-of-pandora', 'baldurs-gate-3', 'beyond-two-souls', 'celeste', 'clair-obscur-expedition-33', 'dead-cells', 'demons-souls', 'detroit-become-human', 'final-fantasy-vii-remake', 'final-fantasy-vii-rebirth', 'final-fantasy-xvi', 'god-of-war', 'hades', 'heavy-rain', 'hogwarts-legacy', 'horizon-forbidden-west', 'horizon-zero-dawn', 'it-takes-two', 'life-is-strange-double-exposure', 'life-is-strange-remastered', 'life-is-strange-true-colors', 'marvels-spider-man', 'marvels-spider-man-miles-morales', 'resident-evil', 'resident-evil-2-remake', 'resident-evil-3-remake', 'resident-evil-5', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'stray', 'the-witcher-3-wild-hunt'].includes(normalizedSlug) ? 'editorial_ptbr' : 'trusted_steam_ptbr')) : '',
        type: item.type,
        description,
        ...
        descriptionPtSource: supportsLocalizedDescriptions && LOCALIZED_TROPHY_SOURCE_SLUGS.has(normalizedSlug) ? (seedTrophy?.descriptionPtSource || (['a-way-out', 'assassin-s-creed-origins', 'assassin-s-creed-odyssey', 'avatar-frontiers-of-pandora', 'baldurs-gate-3', 'beyond-two-souls', 'celeste', 'clair-obscur-expedition-33', 'dead-cells', 'demons-souls', 'detroit-become-human', 'final-fantasy-vii-remake', 'final-fantasy-vii-rebirth', 'final-fantasy-xvi', 'hades', 'heavy-rain', 'hogwarts-legacy', 'horizon-forbidden-west', 'horizon-zero-dawn', 'it-takes-two', 'life-is-strange-double-exposure', 'life-is-strange-remastered', 'life-is-strange-true-colors', 'marvels-spider-man', 'marvels-spider-man-miles-morales', 'resident-evil', 'resident-evil-2-remake', 'resident-evil-3-remake', 'resident-evil-5', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'stray', 'the-witcher-3-wild-hunt'].includes(normalizedSlug) ? 'editorial_ptbr' : 'trusted_steam_ptbr')) : '',
        tip,
...
function normalizeListRow(row) {
  ...
  const seedGame = (!preferManualVerifiedEditorial && (CATALOG_SEED_EDITORIAL_STATUS_SLUGS.has(normalizedSlug) || normalizedSlug === 'assassin-s-creed-shadows' || normalizedSlug === 'assassin-s-creed-valhalla' || normalizedSlug === 'clair-obscur-expedition-33' || normalizedSlug === 'days-gone' || normalizedSlug === 'hogwarts-legacy' || normalizedSlug === 'it-takes-two' || normalizedSlug === 'stray'))
    ? listSeedGame
    : null;
  ...
  const usesCatalogSeedMissableFlags = usesCatalogSeedFlags || ['a-way-out', 'assassin-s-creed-origins', 'assassin-s-creed-odyssey', 'assassin-s-creed-shadows', 'assassin-s-creed-valhalla', 'it-takes-two', 'stray', 'the-witcher-3-wild-hunt'].includes(normalizedSlug);
