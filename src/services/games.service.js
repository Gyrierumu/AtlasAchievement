...
function normalizeGame(row, roadmapRows, trophyRows) {
  ...
  const useSeedTrophyRows = ['a-way-out', 'armored-core-vi-fires-of-rubicon', 'assassins-creed-mirage', 'assassins-creed-origins', 'assassins-creed-odyssey', 'assassins-creed-shadows', 'assassins-creed-valhalla', 'baldurs-gate-3', 'cyberpunk-2077', 'dark-souls-ii-scholar-of-the-first-sin', 'disney-epic-mickey-rebrushed', 'it-takes-two', 'lego-batman-legacy-of-the-dark-knight', 'stray', 'the-witcher-3-wild-hunt'].includes(normalizedSlug) && Array.isArray(seedGame?.trophies) && seedGame.trophies.length > 0;
  ...
  const useSeedRoadmap = ['a-way-out', 'armored-core-vi-fires-of-rubicon', 'assassins-creed-mirage', 'assassins-creed-origins', 'assassins-creed-odyssey', 'assassins-creed-shadows', 'assassins-creed-valhalla', 'baldurs-gate-3', 'bloodborne', 'clair-obscur-expedition-33', 'cyberpunk-2077', 'dark-souls-ii-scholar-of-the-first-sin', 'dark-souls-iii', 'dark-souls-remastered', 'days-gone', 'dead-cells', 'death-stranding', 'death-stranding-2-on-the-beach', 'detroit-become-human', 'disney-epic-mickey-rebrushed', 'god-of-war', 'god-of-war-ragnarok', 'hades', 'hogwarts-legacy', 'hollow-knight-silksong', 'horizon-forbidden-west', 'horizon-zero-dawn', 'it-takes-two', 'lego-batman-legacy-of-the-dark-knight', 'lies-of-p', 'life-is-strange-double-exposure', 'life-is-strange-remastered', 'lords-of-the-fallen', 'marvels-spider-man', 'marvels-spider-man-2', 'marvels-spider-man-miles-morales', 'red-dead-redemption-2', 'resident-evil', 'resident-evil-2-remake', 'resident-evil-3-remake', 'resident-evil-5', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'resident-evil-requiem', 'sekiro-shadows-die-twice', 'stray', 'the-witcher-3-wild-hunt', 'until-dawn'].includes(normalizedSlug) && Array.isArray(seedGame?.roadmap);
  const explicitOfflineBaseSlugs = ['armored-core-vi-fires-of-rubicon', 'assassins-creed-mirage', 'baldurs-gate-3', 'bloodborne', 'clair-obscur-expedition-33', 'cyberpunk-2077', 'dark-souls-ii-scholar-of-the-first-sin', 'dark-souls-iii', 'dark-souls-remastered', 'days-gone', 'detroit-become-human', 'disney-epic-mickey-rebrushed', 'elden-ring', 'astro-bot', 'astros-playroom', 'dead-cells', 'god-of-war', 'god-of-war-ragnarok', 'hades', 'hogwarts-legacy', 'hollow-knight', 'hollow-knight-silksong', 'horizon-forbidden-west', 'horizon-zero-dawn', 'life-is-strange-double-exposure', 'life-is-strange-remastered', 'lego-batman-legacy-of-the-dark-knight', 'marvels-spider-man', 'marvels-spider-man-2', 'marvels-spider-man-miles-morales', 'nioh-2', 'nioh-3', 'resident-evil', 'resident-evil-2-remake', 'resident-evil-3-remake', 'resident-evil-5', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'resident-evil-requiem', 'saros', 'sekiro-shadows-die-twice', 'the-last-of-us-part-i', 'the-last-of-us-part-ii', 'subnautica', 'until-dawn'];
  ...
  return {
    ...
    difficultyTrophiesRequired: ['baldurs-gate-3', 'dead-cells', 'resident-evil', 'resident-evil-2-remake', 'resident-evil-3-remake', 'resident-evil-5', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'the-witcher-3-wild-hunt'].includes(normalizedSlug) ? true : (['armored-core-vi-fires-of-rubicon', 'assassins-creed-mirage', 'clair-obscur-expedition-33', 'dark-souls-ii-scholar-of-the-first-sin', 'days-gone', 'detroit-become-human', 'disney-epic-mickey-rebrushed', 'god-of-war-ragnarok', 'hogwarts-legacy', 'horizon-forbidden-west', 'horizon-zero-dawn', 'lego-batman-legacy-of-the-dark-knight', 'marvels-spider-man', 'marvels-spider-man-2', 'marvels-spider-man-miles-morales', 'the-last-of-us-part-i', 'the-last-of-us-part-ii'].includes(normalizedSlug) ? false : undefined),
    ...
    trophies: normalizedTrophyRows.map(item => {
      ...
      const useSeedEditorialTrophy = ['a-way-out', 'armored-core-vi-fires-of-rubicon', 'assassins-creed-mirage', 'assassins-creed-origins', 'assassins-creed-odyssey', 'assassins-creed-shadows', 'assassins-creed-valhalla', 'baldurs-gate-3', 'bloodborne', 'celeste', 'clair-obscur-expedition-33', 'cyberpunk-2077', 'dark-souls-ii-scholar-of-the-first-sin', 'dark-souls-iii', 'dark-souls-remastered', 'days-gone', 'dead-cells', 'death-stranding', 'death-stranding-2-on-the-beach', 'detroit-become-human', 'disney-epic-mickey-rebrushed', 'god-of-war', 'god-of-war-ragnarok', 'hades', 'hogwarts-legacy', 'hollow-knight-silksong', 'horizon-forbidden-west', 'horizon-zero-dawn', 'it-takes-two', 'lego-batman-legacy-of-the-dark-knight', 'lies-of-p', 'life-is-strange-double-exposure', 'life-is-strange-remastered', 'lords-of-the-fallen', 'marvels-spider-man', 'marvels-spider-man-2', 'marvels-spider-man-miles-morales', 'red-dead-redemption-2', 'resident-evil', 'resident-evil-2-remake', 'resident-evil-3-remake', 'resident-evil-5', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'resident-evil-requiem', 'stray', 'the-witcher-3-wild-hunt', 'until-dawn'].includes(normalizedSlug) && seedTrophy;
      ...
      return {
        ...
        descriptionPtSource: supportsLocalizedDescriptions && LOCALIZED_TROPHY_SOURCE_SLUGS.has(normalizedSlug) ? (seedTrophy?.descriptionPtSource || (['a-way-out', 'assassins-creed-origins', 'assassins-creed-odyssey', 'baldurs-gate-3', 'celeste', 'clair-obscur-expedition-33', 'dead-cells', 'detroit-become-human', 'hades', 'hogwarts-legacy', 'horizon-forbidden-west', 'horizon-zero-dawn', 'it-takes-two', 'life-is-strange-double-exposure', 'life-is-strange-remastered', 'marvels-spider-man', 'marvels-spider-man-miles-morales', 'resident-evil', 'resident-evil-2-remake', 'resident-evil-3-remake', 'resident-evil-5', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'stray', 'the-witcher-3-wild-hunt'].includes(normalizedSlug) ? 'editorial_ptbr' : 'trusted_steam_ptbr')) : '',
        tip,
...
function normalizeListRow(row) {
  ...
  const editorialSource = seedGame
    ...
    : row;
  const usesCatalogSeedFlags = ['baldurs-gate-3', 'bloodborne', 'cyberpunk-2077', 'dark-souls-ii-scholar-of-the-first-sin', 'dark-souls-iii', 'dark-souls-remastered', 'disney-epic-mickey-rebrushed', 'hogwarts-legacy', 'horizon-forbidden-west', 'horizon-zero-dawn', 'resident-evil-7-biohazard', 'resident-evil-village'].includes(normalizedSlug);
  ...
  const useCatalogSeedTiming = ['baldurs-gate-3', 'cyberpunk-2077', 'dark-souls-ii-scholar-of-the-first-sin', 'disney-epic-mickey-rebrushed'].includes(normalizedSlug) && seedGame;
  return {
    ...row,
