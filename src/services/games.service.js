...
function normalizeGame(row, roadmapRows, trophyRows) {
  ...
  return {
    ...
    chapterSelect: ['detroit-become-human', 'life-is-strange-remastered', 'resident-evil-5', 'resident-evil-6', 'the-last-of-us-part-i', 'the-last-of-us-part-ii', 'until-dawn'].includes(normalizedSlug) ? true : (['nioh-3', 'saros', 'subnautica'].includes(normalizedSlug) ? false : undefined),
