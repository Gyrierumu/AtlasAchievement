...
function normalizeGame(row, roadmapRows, trophyRows) {
  ...
  const editorialSource = (usePrinceOfPersiaLostCrownSeedEditorial || useRatchetRiftApartSeedEditorial || useReturnalSeedEditorial || useRoad96SeedEditorial || useSplitFictionSeedEditorial || useStarWarsJediFallenOrderSeedEditorial || useStarWarsJediSurvivorSeedEditorial || useBlackMythWukongSeedEditorial || VERIFIED_PERSONA_GUIDE_SLUGS.has(normalizedSlug) || ['a-way-out', 'armored-core-vi-fires-of-rubicon', 'assassins-creed-mirage', 'assassins-creed-origins', 'assassins-creed-odyssey', 'assassins-creed-shadows', 'assassin-s-creed-valhalla', 'avatar-frontiers-of-pandora', 'baldurs-gate-3', 'beyond-two-souls', 'bloodborne', 'clair-obscur-expedition-33', 'cyberpunk-2077', 'dark-souls-ii-scholar-of-the-first-sin', 'dark-souls-iii', 'dark-souls-remastered', 'days-gone', 'death-stranding', 'death-stranding-2-on-the-beach', 'demons-souls', 'detroit-become-human', 'disney-epic-mickey-rebrushed', 'dragons-dogma-2', 'final-fantasy-vii-remake', 'final-fantasy-vii-rebirth', 'final-fantasy-xvi', 'gran-turismo-7', 'hades', 'heavy-rain', 'hogwarts-legacy', 'hollow-knight-silksong', 'horizon-forbidden-west', 'horizon-zero-dawn', 'it-takes-two', 'lies-of-p', 'life-is-strange-double-exposure', 'life-is-strange-remastered', 'life-is-strange-true-colors', 'little-nightmares-ii', 'lords-of-the-fallen', 'marvels-spider-man', 'marvels-spider-man-2', 'marvels-spider-man-miles-morales', 'reanimal', 'red-dead-redemption-2', 'resident-evil', 'resident-evil-2-remake', 'resident-evil-3-remake', 'resident-evil-5', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'resident-evil-requiem', 'sekiro-shadows-die-twice', 'stray', 'the-witcher-3-wild-hunt', 'until-dawn'].includes(normalizedSlug)) && seedGame
    ? {
        ...row,
        ...seedGame,
  ...
  const useSeedRoadmap = (usePrinceOfPersiaLostCrownSeedEditorial || useRatchetRiftApartSeedEditorial || useReturnalSeedEditorial || useRoad96SeedEditorial || useSplitFictionSeedEditorial || useStarWarsJediFallenOrderSeedEditorial || useStarWarsJediSurvivorSeedEditorial || useBlackMythWukongSeedEditorial || VERIFIED_PERSONA_GUIDE_SLUGS.has(normalizedSlug) || ['a-way-out', 'armored-core-vi-fires-of-rubicon', 'assassins-creed-mirage', 'assassins-creed-origins', 'assassins-creed-odyssey', 'assassins-creed-shadows', 'assassin-s-creed-valhalla', 'avatar-frontiers-of-pandora', 'baldurs-gate-3', 'beyond-two-souls', 'bloodborne', 'clair-obscur-expedition-33', 'cyberpunk-2077', 'dark-souls-ii-scholar-of-the-first-sin', 'dark-souls-iii', 'dark-souls-remastered', 'days-gone', 'dead-cells', 'death-stranding', 'death-stranding-2-on-the-beach', 'demons-souls', 'detroit-become-human', 'disney-epic-mickey-rebrushed', 'dragons-dogma-2', 'final-fantasy-vii-remake', 'final-fantasy-vii-rebirth', 'final-fantasy-xvi', 'god-of-war', 'god-of-war-ragnarok', 'gran-turismo-7', 'hades', 'heavy-rain', 'hogwarts-legacy', 'hollow-knight-silksong', 'horizon-forbidden-west', 'horizon-zero-dawn', 'it-takes-two', 'lego-batman-legacy-of-the-dark-knight', 'lies-of-p', 'life-is-strange-double-exposure', 'life-is-strange-remastered', 'life-is-strange-true-colors', 'little-nightmares-ii', 'lords-of-the-fallen', 'marvels-spider-man', 'marvels-spider-man-2', 'marvels-spider-man-miles-morales', 'reanimal', 'red-dead-redemption-2', 'resident-evil', 'resident-evil-2-remake', 'resident-evil-3-remake', 'resident-evil-5', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'resident-evil-requiem', 'sekiro-shadows-die-twice', 'stray', 'the-evil-within', 'the-witcher-3-wild-hunt', 'until-dawn'].includes(normalizedSlug)) && Array.isArray(seedGame?.roadmap);
  ...
  return {
    ...
    trophies: normalizedTrophyRows.map(item => {
      ...
      const useSeedEditorialTrophy = (usePrinceOfPersiaLostCrownSeedEditorial || useRatchetRiftApartSeedEditorial || useReturnalSeedEditorial || useRoad96SeedEditorial || useSplitFictionSeedEditorial || useStarWarsJediFallenOrderSeedEditorial || useStarWarsJediSurvivorSeedEditorial || useBlackMythWukongSeedEditorial || VERIFIED_PERSONA_GUIDE_SLUGS.has(normalizedSlug) || ['a-way-out', 'armored-core-vi-fires-of-rubicon', 'assassins-creed-mirage', 'assassins-creed-origins', 'assassins-creed-odyssey', 'assassins-creed-shadows', 'assassin-s-creed-valhalla', 'avatar-frontiers-of-pandora', 'baldurs-gate-3', 'beyond-two-souls', 'bloodborne', 'celeste', 'clair-obscur-expedition-33', 'cyberpunk-2077', 'dark-souls-ii-scholar-of-the-first-sin', 'dark-souls-iii', 'dark-souls-remastered', 'days-gone', 'dead-cells', 'death-stranding', 'death-stranding-2-on-the-beach', 'demons-souls', 'detroit-become-human', 'disney-epic-mickey-rebrushed', 'dragons-dogma-2', 'final-fantasy-vii-remake', 'final-fantasy-vii-rebirth', 'final-fantasy-xvi', 'god-of-war', 'god-of-war-ragnarok', 'gran-turismo-7', 'hades', 'heavy-rain', 'hogwarts-legacy', 'hollow-knight-silksong', 'horizon-forbidden-west', 'horizon-zero-dawn', 'it-takes-two', 'lego-batman-legacy-of-the-dark-knight', 'lies-of-p', 'life-is-strange-double-exposure', 'life-is-strange-remastered', 'life-is-strange-true-colors', 'little-nightmares-ii', 'lords-of-the-fallen', 'marvels-spider-man', 'marvels-spider-man-2', 'marvels-spider-man-miles-morales', 'reanimal', 'red-dead-redemption-2', 'resident-evil', 'resident-evil-2-remake', 'resident-evil-3-remake', 'resident-evil-5', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'resident-evil-requiem', 'silent-hill-2-remake', 'stray', 'the-evil-within', 'the-witcher-3-wild-hunt', 'until-dawn'].includes(normalizedSlug)) && seedTrophy;
...
function normalizeListRow(row) {
  ...
  const seedGame = (!preferManualVerifiedEditorial && (CATALOG_SEED_EDITORIAL_STATUS_SLUGS.has(normalizedSlug) || normalizedSlug === 'assassins-creed-shadows' || normalizedSlug === 'assassin-s-creed-valhalla' || normalizedSlug === 'clair-obscur-expedition-33' || normalizedSlug === 'days-gone' || normalizedSlug === 'hogwarts-legacy' || normalizedSlug === 'it-takes-two' || normalizedSlug === 'stray'))
    ? listSeedGame
    : null;
  ...
  const usesCatalogSeedMissableFlags = usesCatalogSeedFlags || ['a-way-out', 'assassins-creed-origins', 'assassins-creed-odyssey', 'assassins-creed-shadows', 'assassin-s-creed-valhalla', 'it-takes-two', 'stray', 'the-witcher-3-wild-hunt'].includes(normalizedSlug);
