(function attachCatalogModel(root, factory) {
  ...
  const catalogFacetMeta = {
    all: {
      ...
      slug: 'all',
      path: '/catalogo',
      title: 'Catálogo de jogos – Escolha sua próxima platina no AtlasAchievement',
      description: 'Explore jogos por tempo, dificuldade e riscos como troféus perdíveis ou online obrigatório para escolher sua próxima platina.',
      name: 'Catálogo de jogos',
      heroTitle: 'Filtre por tempo, dificuldade e risco',
      heroDescription: 'Compare jogos por duração, desafio, troféus perdíveis, online obrigatório e status editorial antes de abrir o guia.',
      collectionTitle: 'Catálogo completo de guias de platina',
