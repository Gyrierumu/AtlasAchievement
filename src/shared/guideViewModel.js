(function attachGuideViewModel(root, factory) {
  ...
  function getExplicitGuideTrophyTags(trophy = {}, game = {}) {
    const slug = String(game?.slug || '').trim().toLowerCase();
    if (!['a-way-out', 'armored-core-vi-fires-of-rubicon', 'assassin-s-creed-mirage', 'assassin-s-creed-origins', 'assassin-s-creed-odyssey', 'assassin-s-creed-shadows', 'assassin-s-creed-valhalla', 'avatar-frontiers-of-pandora', 'baldurs-gate-3', 'beyond-two-souls', 'black-myth-wukong', 'celeste', 'clair-obscur-expedition-33', 'cyberpunk-2077', 'dark-souls-ii-scholar-of-the-first-sin', 'dark-souls-remastered', 'days-gone', 'demons-souls', 'detroit-become-human', 'disney-epic-mickey-rebrushed', 'dragons-dogma-2', 'final-fantasy-vii-remake', 'final-fantasy-vii-rebirth', 'final-fantasy-xvi', 'gran-turismo-7', 'hades', 'heavy-rain', 'hogwarts-legacy', 'hollow-knight-silksong', 'it-takes-two', 'lies-of-p', 'life-is-strange-double-exposure', 'life-is-strange-remastered', 'life-is-strange-true-colors', 'little-nightmares-ii', 'lords-of-the-fallen', 'metaphor-refantazio', 'monster-hunter-world', 'persona-3-reload', 'persona-5-royal', 'prince-of-persia-the-lost-crown', 'ratchet-and-clank-rift-apart', 'reanimal', 'resident-evil-6', 'resident-evil-7-biohazard', 'resident-evil-village', 'returnal', 'road-96', 'sekiro-shadows-die-twice', 'silent-hill-2-remake', 'split-fiction', 'star-wars-jedi-fallen-order', 'star-wars-jedi-survivor', 'stray', 'the-evil-within', 'the-evil-within-2', 'the-witcher-3-wild-hunt', 'until-dawn'].includes(slug)) return [];
