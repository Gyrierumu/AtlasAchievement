(function attachGuideViewModel(root, factory) {
  ...
  const RESIDENT_EVIL_2_TAG_FIXES_BY_ID = {
    ...
    re2r_heads_ringin: { add: [{ id: 'combat', label: 'Combate', tone: 'warning' }, { id: 'situational', label: 'Situacional', tone: 'warning' }] },
      ...
      return [
        {
          ...
          tags: [attentionTag('Perdível / Boss / Risco de run', 'risk')],
          score: 99
        },
        {
          id: 're2r_blink_eye',
        ...
        {
          id: 're2r_time_spare',
          name: trophyById.get('re2r_time_spare')?.name_pt || 'Com Tempo de Sobra',
          originalName: trophyById.get('re2r_time_spare')?.name || 'With Time to Spare',
          type: 'Perdível / Boss / Risco de run',
          text: 'Exclusivo da Claire. Salve antes da fuga final do NEST, reserve munição pesada e conclua G Stage 4 com pelo menos 4 minutos restantes; se falhar, recarregue.',
          tags: [attentionTag('Perdível / Boss / Risco de run', 'risk')],
          score: 97
        },
        {
